...
use App\Filament\Resources\PaymentMethods\Pages\ViewPaymentMethods;
use App\Filament\Resources\PaymentMethods\Schemas\PaymentMethodsForm;
use App\Filament\Resources\PaymentMethods\Schemas\PaymentMethodsInfolist;
...
class PaymentMethodsResource extends Resource
{
    ...
    {
        return PaymentMethodsInfolist::configure($schema);
    }
    ...
    public static function getPages(): array
    {
        return [
            ...
            'view' => ViewPaymentMethods::route('/{record}'),
